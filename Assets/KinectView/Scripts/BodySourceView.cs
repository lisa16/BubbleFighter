...
public class BodySourceView : MonoBehaviour
{
	...
	void Update()
	{
		...
		foreach (Kinect.Body body in rawBodies)
		{
			...
			if (body.IsTracked)
			{
				...
				bool isPlayer1 = PlayerTracking.player1TrackNum == body.TrackingId;
				RefreshBodyObject(body, _Bodies[body.TrackingId], isPlayer1);
			}
		}
	}
	...
	private void RefreshBodyObject(Kinect.Body body, GameObject bodyObject, bool isPlayer1)
	{
